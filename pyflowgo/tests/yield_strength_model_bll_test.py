...
class MyTestCase(unittest.TestCase):
    ...
    def test_compute_yield_strength(self):
        ...
        self.assertAlmostEqual(yield_strength, 5.964581813725559,10)

    def test_compute_basal_shear_stress(self):

        yield_strength_model_ryerson = pyflowgo.flowgo_yield_strength_model_ryerson.FlowGoYieldStrengthModelBLL()
        ...
        state = pyflowgo.flowgo_state.FlowGoState()
        basal_shear_stress = yield_strength_model_bll.compute_basal_shear_stress(state, terrain_condition,
                                                                                   material_lava)

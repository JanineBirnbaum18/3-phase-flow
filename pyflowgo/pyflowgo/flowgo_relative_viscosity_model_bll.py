...
class FlowGoRelativeViscosityModelBLL(pyflowgo.base.flowgo_base_relative_viscosity_model.
    ...
    Birnbaum, Lev, and Llewellin. They propose a treatment for the viscosity of a three‐phase mixture
    ...
    def read_initial_condition_from_json_file(self, filename):
        ...
        with open(filename) as data_file:
            ...
            self._beinstein_gas = float(data['relative_viscosity_parameters']['einstein_coef_gas'])
    ...
    def compute_relative_viscosity(self, state):
        ...
        relative_viscosity = (1. - (phi / (self._phimax*(1. - vesicle_fraction)))) ** (-self._beinstein) * \
                             (1. - vesicle_fraction) ** (-self._beinstein_gas)
